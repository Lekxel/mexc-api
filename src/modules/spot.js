...
const Spot = (superclass) =>
  class extends superclass {
    ...
    defaultSymbols(options = {}) {
      return this.PublicRequest("GET", "/open/api/v2/market/ticker", options);
    }
    ...
    //深度信息
    depth(options = {}) {
      return this.PublicRequest("GET", "/open/api/v2/market/depth", options);
    }

    //成交记录
    deals(options = {}) {
      return this.PublicRequest("GET", "/open/api/v2/market/deals", options);
    }

    //K线数据
    kline(options = {}) {
      return this.PublicRequest("GET", "/open/api/v2/market/kline", options);
    }
    ...
    //账户余额
    account(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/account/info", options);
    }
    ...
    //下单
    placeOrder(options = {}) {
      return this.SignRequest("POST", "/open/api/v2/order/place", options);
    }

    //撤销订单
    cancelOrder(options = {}) {
      return this.SignRequest("DELETE", "/open/api/v2/order/cancel", options);
    }
    ...
    getOpenOrder(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/order/open_orders", options);
    }

    //所有订单
    getAllOrder(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/order/list", options);
    }

    //查询订单
    queryOrderById(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/order/query", options);
    }

    //个人成交记录
    getOrderDeal(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/order/deals", options);
    }

    //成交明细
    queryOrderDealById(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/order/deal_detail", options);
    }
    ...
    //提币
    withdraw(options = {}) {
      return this.SignRequest("POST", "/open/api/v2/asset/withdraw", options);
    }

    //取消提币
    cancelWithdraw(options = {}) {
      return this.SignRequest("DELETE", "/open/api/v2/asset/withdraw", options);
    }
    ...
    getAvlTransfer(options = {}) {
      return this.SignRequest("GET", "/open/api/v2/account/balance", options);
    }
    ...
    //深度信息
    Depth(options = {}) {
      return this.publicRequest("GET", "/api/v3/depth", options);
    }

    //近期成交列表
    RecentTradesList(options = {}) {
      return this.publicRequest("GET", "/api/v3/trades", options);
    }

    //近期成交（归集）
    CompressedTradesList(options = {}) {
      return this.publicRequest("GET", "/api/v3/aggTrades", options);
    }

    //K线数据
    Kline(options = {}) {
      return this.publicRequest("GET", "/api/v3/klines", options);
    }

    //当前平均价格
    CurrentAveragePrice(options = {}) {
      return this.publicRequest("GET", "/api/v3/avgPrice", options);
    }
    ...
    //用户API交易对
    SelfSymbol(options = {}) {
      return this.signRequest("GET", "/api/v3/selfSymbols", options);
    }

    //测试下单
    TestConnectivity(options = {}) {
      return this.signRequest("POST", "/api/v3/order/test", options);
    }

    //下单
    Order(options = {}) {
      return this.signRequest("POST", "/api/v3/order", options);
    }

    //批量下单
    BatchOrders(options = {}) {
      return this.signRequest("POST", "/api/v3/batchOrders", options);
    }

    //撤销订单
    CancelOrder(options = {}) {
      return this.signRequest("DELETE", "/api/v3/order", options);
    }

    //撤销单一交易对所有订单
    CancelallOpenOrders(options = {}) {
      return this.signRequest("DELETE", "/api/v3/openOrders", options);
    }

    //查询订单
    QueryOrder(options = {}) {
      return this.signRequest("GET", "/api/v3/order", options);
    }
    ...
    //查询所有订单
    AllOrders(options = {}) {
      return this.signRequest("GET", "/api/v3/allOrders", options);
    }
    ...
    AccountTradeList(options = {}) {
      return this.signRequest("GET", "/api/v3/myTrades", options);
    }

    //开启MX抵扣
    MxDeduct(options = {}) {
      return this.signRequest("POST", "api/v3/mxDeduct/enable", options);
    }

    //查看MX抵扣状态
    MxDeducth(options = {}) {
      return this.signRequest("GET", "api/v3/mxDeduct/enableh", options);
    }
    //*母子账户接口*//
    ...
    SubAccountList(options = {}) {
      return this.signRequest("GET", "/api/v3/sub-account/list", options);
    }

    //创建子账户的APIkey
    VirtualApikey(options = {}) {
      return this.signRequest("POST", "/api/v3/sub-account/apiKey", options);
    }

    //查询子账户的APIkey
    GetApiKey(options = {}) {
      return this.signRequest("GET", "/api/v3/sub-account/apiKey", options);
    }

    //删除子账户的APIkey
    DelApikey(options = {}) {
      return this.signRequest("DELETE", "/api/v3/sub-account/apiKey", options);
    }
    ...
    //查询币种信息
    CoinList(options = {}) {
      return this.signRequest("GET", "/api/v3/capital/config/getall", options);
    }
    ...
    //取消提币
    CancelWithdraw(options = {}) {
      return this.signRequest("DELETE", "/api/v3/capital/withdraw", options);
    }
    //获取充值历史
    DepositHisrec(options = {}) {
      return this.signRequest("GET", "/api/v3/capital/deposit/hisrec", options);
    }
    ...
    //用户万向划转
    Transfer(options = {}) {
      return this.signRequest("POST", "/api/v3/capital/transfer", options);
    }

    //查询用户万向划转历史
    TransferHistory(options = {}) {
      return this.signRequest("GET", "/api/v3/capital/transfer", options);
    }
    ...
    //获取小额资产可兑换列表
    Capital(options = {}) {
      return this.signRequest("GET", "/api/v3/capital/convert/list", options);
    }

    //小额资产兑换
    CapitalConvert(options = {}) {
      return this.signRequest("POST", "/api/v3/capital/convert", options);
    }

    //查询小额资产兑换历史
    CapitalHistory(options = {}) {
      return this.signRequest("GET", "/api/v3/capital/convert", options);
    }
    ...
    //  获取邀请返佣记录
    TaxQuery(options = {}) {
      return this.signRequest("GET", "/api/v3/rebate/taxQuery", options);
    }

    // 获取返佣记录明细 （奖励记录）
    RebateDetail(options = {}) {
      return this.signRequest("GET", "/api/v3/rebate/detail", options);
    }

    // 获取自返记录明细 （奖励记录）
    KickBack(options = {}) {
      return this.signRequest("GET", "/api/v3/rebate/detail/kickback", options);
    }

    // 获取邀请人
    ReferCode(options = {}) {
      return this.signRequest("GET", "/api/v3/rebate/referCode", options);
    }
    ...
    KeepListenKey(options = {}) {
      return this.signRequest("PUT", "/api/v3/userDataStream", options);
    }

    //关闭listenkey
    CloseListenKey(options = {}) {
      return this.signRequest("DELETE", "/api/v3/userDataStream", options);
    }

    /////////  P2P  /////////
    FetchP2PTrades(options = {}) {
      return this.signRequest(
        "GET",
        "/api/v3/fiat/merchant/order/pagination",
        options
      );
    }
    ...
    RetrieveChatConversation(options) {
      return this.signRequest(
        "GET",
